...
# *********************added by me starts here ***********************
# ============================================================
# UPDATED RESPONSE GENERATION FUNCTION -- system prompt added
# ============================================================
...
def main(evaluation, compute_metric, csv_path):
    ...
    if compute_metric:
        ...
        rr = compute_refusal_rate_from_predictions("/home/malam10/projects/ai-safety-bangla/FineTuned_Models/Llama-2-7b-chat-hf_LoRA_CE+Contrastive/results/generated_predictions.jsonl")
        print("rr: ", rr)

        rr, rc, t = compute_refusal_rate_verbose("/home/malam10/projects/ai-safety-bangla/FineTuned_Models/Llama-2-7b-chat-hf_LoRA_CE+Contrastive/results/generated_predictions.jsonl")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--csv_path", type=str, default="/home/malam10/projects/ai-safety-bangla/FineTuned_Models/Llama-2-7b-chat-hf_LoRA_CE+Contrastive/results/basic_predictions.csv")
