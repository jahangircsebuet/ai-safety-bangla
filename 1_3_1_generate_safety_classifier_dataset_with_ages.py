...
class BanglaSafetyDatasetGenerator:
    ...
    def add_aegis_data(self, file_path: str = "datasets/converted_aegis_bangla.json") -> None:
        """
        Add Aegis (Bangla converted) prompts from the specified file.
        Accepts either {"prompts": [...]} or a raw list of dicts.
        
        Args:
            file_path: Path to the Aegis dataset file
        """
        ...
        try:
            ...
            # Support {"prompts": [...]} or raw list
            prompts = data.get("prompts") if isinstance(data, dict) else data
            if not isinstance(prompts, list):
                print(f"  ❌ Unexpected Aegis file format at: {file_path}")
                return
            ...
            for item in prompts:
                ...
                if prompt:
                    mapped = "safe" if lab == "safe" else "unsafe"
                    self.compiled_data.append({
                        "prompt": prompt,
                        "label": mapped,
                        "source": "aegis"
            ...
            print(f"  ❌ Error loading Aegis data: {e}")
    ...
    def generate_dataset(self, 
                        ...
                        aegis_path: str = "datasets/converted_aegis_bangla.json") -> Dict[str, Any]:
        """
        ...
        Args:
            ...
            aegis_path: Path to the Aegis dataset file
