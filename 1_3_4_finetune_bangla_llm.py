...
# -----------------------------
train_df.to_json("banglaguard_train.json", orient="records", force_ascii=False, indent=2)
test_df.to_json("banglaguard_test.json", orient="records", force_ascii=False, indent=2)
...
dataset = load_dataset("json", data_files={
    "train": "banglaguard_train.json",
    "test": "banglaguard_test.json"
})
...
with open("eval_results_baseline.json", "w", encoding="utf-8") as f:
...
with open("eval_results_finetuned.json", "w", encoding="utf-8") as f:
